...
exports.default = class extends _yeomanGenerator2.default {
  ...
  writing() {
    ...
    (0, _request2.default)(`http://cmp.beisen.io/users/create-project?project=${projectName}&username=${username}`, (err, resp, body) => {
      if (err) {
      ...
      (0, _child_process.exec)(`git clone git@gitlab.beisencorp.com:${data.group}/${projectName}.git`, (error, stdout, stderr) => {
        if (error) {
  ...
  */
  _copyTemplateFiles() {
    ...
    ['index.js', 'src/index.js'], ['example.js', 'examples/default/index.js'], ['npmignore', '.npmignore'], ['package.json'], ['README.md'], ['.bscpmrc.json']]);
  }
