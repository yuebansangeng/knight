  ...
  writing() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield new _bluebird2.default(function (resolve, reject) {
        // buildonly: 只生成配置文件
        let bo_cp = (0, _child_process.spawn)('node', ['node_modules/.bin/make-stories'], { cwd: _this.contextRoot });
      ...
      let { code, message } = yield new _bluebird2.default(function (resolve, reject) {
        let resmsg = [];
        let build_cp = (0, _child_process.spawn)('node', ['node_modules/.bin/build-storybook', '-c', `./node_modules/@beisen/storybook-lib/lib/.storybook/`, '-o', `./storybook-static/${name}/${version}`], {
