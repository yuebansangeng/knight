...
exports.default = class extends _yeomanGenerator2.default {
  ...
  _private_resolve(path) {
    ...
    // 在这里统一提出，减少代码量、维护成本
    let rc = (0, _genrc2.default)();
    if (_fs2.default.existsSync(`${this.contextRoot}/${RC_FILENAME}`)) {
      rc = _hjson2.default.parse(_fs2.default.readFileSync(`${this.contextRoot}/${RC_FILENAME}`, 'utf-8'));
    }
